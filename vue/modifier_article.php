...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (
        ...
        modifierArticle(
            ...
            $_POST['quantite'],
            $_POST['prix_unitaire'],
            str_replace("T", " ", $_POST['date_fabrication']) . ":00",
    ...
    <div class="home-content">
        <div class="edit-container">
            <div class="edit-card">
                ...
                <div class="subtitle">Modifiez les informations de l'article ci-dessous</div>
                
                <div class="text-center">
                    <span class="article-id-badge">ID: <?= $article['id'] ?></span>
                </div>
                ...
                <form method="post">
                    ...
                    <div class="form-group-edit">
                        ...
                        <select name="categorie" class="input-style-edit">
                            ...
                            <option value="Accessoire" <?= $article['categorie'] == 'Accessoire' ? 'selected' : '' ?>>Accessoire</option>
                        </select>
                    </div>
                    ...
                    <div class="button-group">
                        ...
                        <a href="article.php" class="btn-cancel">
                            ❌ Annuler
                        </a>
                    </div>
